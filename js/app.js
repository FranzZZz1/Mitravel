    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".hero-slider") && document.querySelector(".controls-slider")) {
                ...
                const swiperIMG = new swiper_core_Swiper(".hero-slider", {
                    modules: [ Navigation, Autoplay, Controller ],
                    loop: false,
                    observer: true,
                    observeParents: true,
                    ...
                    effect: "fade",
                    navigation: {
                        prevEl: ".controls-slider__button-prev",
                        nextEl: ".controls-slider__button-next"
                    },
                    autoplay: {
                        delay: 2e3,
                        disableOnInteraction: true
                    ...
                    on: {
                        ...
                        init: function() {
                            ...
                            nextButton.addEventListener("click", (function() {
                                if (!isTransitioning) if (swiper.isEnd) swiper.slideTo(0, sliderSpeed); else swiper.slideNext();
                            }));
                            swiper.on("transitionStart", (function() {
                                isTransitioning = true;
                            }));
                            ...
                            videoContainers.forEach((container => {
                                ...
                                if (isTouchDevice) {
                                    ...
                                    container.removeEventListener("mouseenter", touchEndHandler);
                                    container.removeEventListener("mousedown", touchEndHandler);
                                } else {
                                    container.removeEventListener("touchend", touchEndHandler);
                                    container.addEventListener("mouseenter", touchEndHandler);
                                    container.addEventListener("mousedown", touchEndHandler);
                                }
                                video.addEventListener("play", (function() {
                                    clearTimeout(timeout);
                                    swiper.autoplay.stop();
                                    swiper.allowTouchMove = false;
                                    if (isTouchDevice) container.removeEventListener("touchend", touchEndHandler); else {
                                        container.removeEventListener("mouseenter", touchEndHandler);
                                        container.removeEventListener("mousedown", touchEndHandler);
                                    }
                                }));
                                video.addEventListener("pause", (function() {
                                    ...
                                    if (isTouchDevice) container.addEventListener("touchend", touchEndHandler); else {
                                        container.addEventListener("mouseenter", touchEndHandler);
                                        container.addEventListener("mousedown", touchEndHandler);
                                    }
                                }));
            ...
            if (document.querySelector(".featured-videos__slider")) {
                let swiperSpeed = 600;
                new swiper_core_Swiper(".featured-videos__slider", {
                    modules: [ Navigation, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        const dynamicHeader = function(header, options = {}) {
            ...
            let headerHeight = headerHeightValue ? headerHeightValue : headerElem.offsetHeight;
            ...
            function objectConversion(mainParam, params, mainParamName) {
                if (mainParam) {
                    ...
                    if (invalidKeys.length > 0) console.error(`${mainParam} ${mainParamName}:\nInvalid keys: \n${invalidKeys.join(", \n")}\n-----------------\nAvailable keys: \n${requiredKeys.join(", \n")}`);
                    mainParam = {
                        ...params,
                        ...mainParam
                    };
            ...
            const allObjectConversions = function() {
                ...
                headerScroll = objectConversion(headerScroll, headerScrollParams, "headerScroll");
            ...
            const headerMenuOpen = function() {
                ...
                if (scrollLock && scrollLockArray && scrollLockArray.length > 0) scrollLockArray.forEach((el => {
                ...
                attachEvent(document, "touchmove", handleTouchMove, {
                    passive: false
                });
                attachEvent(document, "wheel", handleWheel, {
                    passive: false
                });
            };
            const headerMenuClose = function() {
                ...
                if (scrollLock && scrollLockArray && scrollLockArray.length > 0) scrollLockArray.forEach((scrollLockElement => {
                    document.querySelector(scrollLockElement).classList.remove(scrollLockClass);
                }));
            ...
            const headerMenuCloseTriggers = function(event) {
                ...
                const stringTypeCheck = function(target) {
                    return typeof target === "string" ? target : console.error(`DynamicHeader: Указан неверный тип данных. Используйте класс для доступа к элементу:`, target);
                };
                ...
                if (!target.closest(`${menuBodySelector}.${menuOpenClass}`) && !target.closest(headerSelector) || target.closest(menuLinkSelector)) headerMenuClose();
            };
            const menuKeyClose = function(event) {
                if (menu && event.code === "Escape") headerMenuCloseTriggers(event);
            };
            const handleTouchMove = function(event) {
                let {scrollLockClass} = scrollLock;
                if (menu && scrollLock && event.target.closest(`.${scrollLockClass}`)) event.preventDefault();
            };
            ...
            const headerScrollWatcher = function() {
                ...
                if (headerScrollPosition >= scrollEndPosition) {
                    ...
                    console.error(`headerScrollEndPosition must be less than or equal to headerScrollPosition`);
                }
            };
        ...
        const videoControl = () => {
            ...
            videos.forEach((video => {
                ...
                const videoContainer = container.querySelector(".hero-slider__video-container");
                const playBtn = container.querySelector(".hero-slider__play");
                const pauseBtn = container.querySelector(".hero-slider__stop");
                const progressContainer = container.querySelector(".hero-slider__progress-container");
                const progressBar = container.querySelector(".hero-slider__progress-bar");
                const progressIndicator = container.querySelector(".hero-slider__progress-indicator");
                const fullscreenBtn = container.querySelector(".hero-slider__fullscreen");
                let timeout;
                ...
                const seekVideo = event => {
                    ...
                    if (event.type === "touchstart" || event.type === "touchmove") {
                        ...
                        if (realTime - lastExecutionTime >= 1900) {
                            applyTimeout(2e3, false);
                            lastExecutionTime = realTime;
                        }
                ...
                if (isTouchDevice) {
                    ...
                    progressContainer.addEventListener("touchmove", seekVideo, {
                        passive: true
                    });
                    progressContainer.addEventListener("touchend", endDrag, {
                        passive: true
                    });
                    videoContainer.removeEventListener("mousedown", cursorDidntMoved);
                    videoContainer.removeEventListener("mousemove", cursorWasMoved);
                    videoContainer.removeEventListener("mouseup", cursorMoveCheck);
                    progressContainer.removeEventListener("mousedown", startDrag);
                    progressContainer.removeEventListener("mouseup", endDrag);
                    progressContainer.removeEventListener("mouseleave", progressMouseLeave);
                    progressContainer.removeEventListener("mousemove", progressDragMouseMove);
                    progressContainer.removeEventListener("mouseenter", progressMouseEnter);
                    progressContainer.removeEventListener("mousemove", updateProgressIndicator);
                } else {
                    progressContainer.addEventListener("mousedown", startDrag);
                    progressContainer.addEventListener("mouseup", endDrag);
                    progressContainer.addEventListener("mouseenter", progressMouseEnter);
                    progressContainer.addEventListener("mouseleave", progressMouseLeave);
                    progressContainer.addEventListener("mousemove", progressDragMouseMove);
                    progressContainer.addEventListener("mousemove", updateProgressIndicator);
                    videoContainer.addEventListener("mousedown", cursorDidntMoved);
                    videoContainer.addEventListener("mousemove", cursorWasMoved);
                    videoContainer.addEventListener("mouseup", cursorMoveCheck);
                    progressContainer.removeEventListener("touchstart", startDrag);
                    progressContainer.removeEventListener("touchmove", seekVideo);
